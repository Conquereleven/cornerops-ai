...
router.get('/commercial/status', controller.commercialStatus);
router.get('/commercial/founder-daily', controller.commercialFounderDaily);
router.get('/commercial/accounts', controller.commercialAccounts);
router.get('/commercial/skus', controller.commercialSkus);
router.get('/commercial/opportunities', controller.commercialOpportunities);
router.get('/commercial/quotes', controller.commercialQuotes);
router.get('/commercial/orders', controller.commercialOrders);
router.get('/commercial/payments', controller.commercialPayments);
router.get('/commercial/fulfillments', controller.commercialFulfillments);
router.get('/commercial/exceptions', controller.commercialExceptions);
router.get('/commercial/daily-closes', controller.commercialDailyCloses);
router.post('/commercial/input-packs/preview', founderActionAuth, controller.previewCommercialInput);
router.post('/commercial/input-packs/confirm', founderActionAuth, controller.confirmCommercialInput);
router.post('/commercial/opportunities', founderActionAuth, controller.createCommercialOpportunity);
router.post('/commercial/quotes', founderActionAuth, controller.createCommercialQuote);
router.post('/commercial/quotes/:id/transition', founderActionAuth, controller.transitionCommercialQuote);
router.post('/commercial/quotes/:id/export', founderActionAuth, controller.exportCommercialQuote);
router.post('/commercial/quotes/:id/accept', founderActionAuth, controller.acceptCommercialQuote);
router.post('/commercial/orders/:id/transition', founderActionAuth, controller.transitionCommercialOrder);
router.post('/commercial/orders/:id/payments', founderActionAuth, controller.recordCommercialPayment);
router.post('/commercial/orders/:id/fulfillment', founderActionAuth, controller.createCommercialFulfillment);
router.post('/commercial/fulfillments/:id/transition', founderActionAuth, controller.transitionCommercialFulfillment);
router.post('/commercial/exceptions/:id/transition', founderActionAuth, controller.transitionCommercialException);
router.post('/commercial/daily-close', founderActionAuth, controller.closeCommercialDay);
