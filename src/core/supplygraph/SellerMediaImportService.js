...
class SellerMediaImportService{
  constructor({internalStore,storage,fetchImpl=global.fetch,config={},bucket='seller-product-assets',allowedMediaHostnames=DEFAULT_MEDIA_HOSTNAMES}={}){this.store=internalStore;this.storage=storage;this.fetchImpl=fetchImpl;this.config=config;this.bucket=bucket;this.allowedMediaHostnames=new Set(allowedMediaHostnames);}
