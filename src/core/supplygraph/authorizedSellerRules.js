...
const VERSIONS = Object.freeze({
  onboarding: 'supplygraph-seller-onboarding-v1.13.0',
  registry: 'supplygraph-seller-registry-v1.13.0',
  snapshot: 'supplygraph-seller-snapshot-v1.13.0',
  media: 'supplygraph-product-media-v1.13.0',
  inventory: 'supplygraph-inventory-v1.13.0',
  match: 'supplygraph-match-v1.13.0',
  comparison: 'supplygraph-comparison-v1.13.0',
});
const LIMITS = Object.freeze({ maxSellers: 32, maxProductsPerSeller: 250, maxTotalProducts: 2000,
