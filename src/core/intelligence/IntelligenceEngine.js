...
const summarizeCounts = (connectorStatus = {}, flowAnalysis = {}, anomalies = []) => ({
  ...
  quoteCount: Number(connectorStatus.rowCounts?.quotes || 0),
  quoteFollowUpCount: flowAnalysis.summary?.candidates?.quote_follow_up_flow || 0,
  orderCount: Number(connectorStatus.rowCounts?.orders || 0),
  orderAttentionCount: flowAnalysis.summary?.candidates?.order_attention_flow || 0,
  customerCount: Number(connectorStatus.rowCounts?.customers || 0),
  paymentCount: Number(connectorStatus.rowCounts?.payments || 0),
  fulfillmentCount: Number(connectorStatus.rowCounts?.fulfillment || 0),
