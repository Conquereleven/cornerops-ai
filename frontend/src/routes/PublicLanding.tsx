...
export function PublicLanding() {
  ...
  return <main className="co-public cg-root studio" ref={root}>
    ...
    <section className="co-public-cta" id="contact"><span className="co-public-eyebrow">Let’s build something useful</span><h2>Have an operation you know should work better?<br/>Let’s fix it.</h2><p>Bring us one workflow that takes too much time. We’ll help you identify what to build first.</p><div className="co-public-actions studio-contact-actions"><a className="co-public-primary" href="https://calendar.app.google/1KYnZsKuFbbGj2Ha8" target="_blank" rel="noopener noreferrer" aria-label="Book a call on Google Calendar (opens in a new tab)">Book a call<span>Google Calendar · 30 minutes</span></a><a className="co-public-secondary" href="mailto:joel.escudero12@gmail.com">Email us<span>joel.escudero12@gmail.com</span></a><a className="co-public-secondary" href="https://wa.me/971555633651" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp at +971 55 563 3651 (opens in a new tab)">Chat on WhatsApp<span>+971 55 563 3651</span></a></div></section>
